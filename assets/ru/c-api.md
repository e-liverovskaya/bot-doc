...
| double funding_rate()           | ставка фондирования; доступна только для некоторых крипто подключений                              |
| long long funding_time()        | время следующего фондирования в формате epoch; доступно только для некоторых крипто подключений   |
