...
- **Email** — адрес электронной почты пользователя, которому присвоены роли в компании. Чтобы добавить пользователя в компанию, он должен иметь роль demo, то есть должен зайти хотя бы раз на платформу с этим email.
...
- **Delete user** — кнопка для удаления пользователя из компании. Она поможет удалить пользователя, если его робот уже удален. Рекомендуется удалять пользователей с ролью Trader без робота в компании, если в ближайшее время не планируется выдавать нового робота в этой компании.
