...
- **Robots** — номер робота, доступ к которому предоставлен;
- **Portfolios** — портфель, доступ к которому предоставлен;
- **Edit user** — вход в меню редактирования ролей и доступов пользователя;
- **Delete user** — кнопка для удаления пользователя из компании.
